              ...
              <Box sx={{ padding: 3 }}>
                {noResults ? (
                  ...
                  feedbacks.map((feedback) => (
                    <Card 
                      key={feedback._id} 
                      sx={{ marginBottom: 2, animation: 'fadeIn 0.5s forwards' }} // Removed opacity; animation should be defined in CSS
                    >
                      <CardContent>
                        <Typography variant="h6">Customer Name: {feedback.customerId}</Typography> {/* Use user name or handle undefined */}
